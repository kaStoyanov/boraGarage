        ...
        (
            <div className="placeorder">
                ...
                <div className="informations-placeorder">
                    ...
                    <hr className='hr' />
                    <div>
                        <h2 style={{ color: "limegreen" }}>Успешно завършена поръчка!</h2>
                        <h3>Очаквайте обаждане за потвърждение.</h3>
                    </div>
                    <hr className='hr' />
                    <hr className='hr' />
                        ...
                        {order.orderItems.length === 0 ? <p>Your order is empty</p> :
                            <div className="orders-placeorder">
                                {order.orderItems.map((item, index) => (
                                    ...
                                    <p key={index}><span className="color-name"><Link to={`/product/${item.product}`}>{item.name}</Link></span> <b>{item.qty} x {item.price} лв = {item.qty * item.price} лв</b><hr className='hr' /></p>
                ...
                <div className="your-products">
                    ...
                    <div className="cart-summ">
                        <h1>Информация за поръчката</h1>

                        <div className="calculs-placeorder">
                            <h3>Items: </h3><p>{order.itemsPrice} лв</p>
                            <h3>Shipping: </h3><p>{order.shippingPrice} лв</p>
                            {/* <h3>Tax: </h3><p>${order.taxPrice}</p> */}
                            <h3>Total: </h3><p>{order.itemsPrice} лв</p>
                        </div>
