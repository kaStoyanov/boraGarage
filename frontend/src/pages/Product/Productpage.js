            ...
            <div className="card">
              ...
              <div className="product-content">
                ...
                <div className="product-price">
                  ...
                  <p className="new-price">Цена: <span>BGN {product.price}</span></p>
                </div>
                ...
                <div className="product-detail">
                  ...
                  <div>
                    <ul>
                      <li>Година</li> <Select className='select-product' placeholder="Choose an option">
                  ...
                  <ul>
                    <li>Статус: <span>{product.countInStock > 0 ? 'ìn stock' : 'Out Of Stock'}</span></li>
                    <li>Марка: <span>{product.category.map(cg => ' | ' + cg + ' | ')}</span></li>
