            ...
            <div className='Cgfilter'>
                ...
                <div className='filters'>
                    <ul>
                        ...
                        <Link className='lined' to='?cg=BMW'>BMW</Link>
                        <Link className='lined' to='?cg=Mercedes'>Mercedes</Link>
                        <Link className='lined' to='?cg=Prosche'>Prosche</Link>
                        <Link className='lined' to='?cg=Audi'>Audi</Link>
